...
namespace dk.nita.saml20.protocol
{
    ...
    public abstract class AbstractEndpointHandler// : IHttpHandler, IRequiresSessionState
    {
        ...
        public abstract void ProcessRequest(SamlHttpContext context);
        ...
        public void HandleError(SamlHttpContext context, string errorMessage, bool overrideConfigSetting)
        {
        ...
        /// <param name="context">The current HTTP context.</param>
        /// <param name="errorMessage">The error message.</param>
        public void HandleError(SamlHttpContext context, string errorMessage)
        {
        ...
        public void HandleError(SamlHttpContext context, Exception e)
        {
        ...
        public void DoRedirect(SamlHttpContext context)
        {
