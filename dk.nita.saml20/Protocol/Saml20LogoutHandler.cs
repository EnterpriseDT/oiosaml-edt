...
namespace dk.nita.saml20.protocol
{
    ...
    public class Saml20LogoutHandler : Saml20AbstractEndpointHandler
    {
        ...
        private void TransferClient(IDPEndPoint endpoint, SamlHttpContext context)
        {
        ...
        private void DoLogout(SamlHttpContext context)
        {
        ...
        private void DoSoapLogout(SamlHttpContext context, string userId)
        {
            try
            {
                foreach (IAction action in Actions.Actions.GetActions())
