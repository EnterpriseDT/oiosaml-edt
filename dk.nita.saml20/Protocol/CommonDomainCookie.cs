...
namespace dk.nita.saml20.protocol
{
    ...
    public class CommonDomainCookie
    {
        ...
        private readonly SamlHttpCookieCollection _cookies;
        ...
        public CommonDomainCookie(SamlHttpCookieCollection cookies)
        {
            _cookies = cookies;
        ...
        private void LoadCookie()
        {
            if(!_isLoaded)
            {
                SamlHttpCookie cdc = _cookies[COMMON_DOMAIN_COOKIE_NAME];
                if(cdc != null)
                {
