...
namespace dk.nita.saml20.Utils
{
    ...
    public static class Trace
    {
        ...
        {
            if (_source != null)
                _source.TraceData(eventType, message);
        }
        ...
        {
            return _source.ShouldTrace(eventType);
        }
    ...
    public interface ITrace
    {
        ...
        void TraceData(TraceEventType eventType, string[] message);
    }
}