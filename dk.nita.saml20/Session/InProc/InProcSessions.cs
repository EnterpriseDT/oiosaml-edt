...
namespace dk.nita.saml20.session.inproc
{
    ...
    {
        private static readonly SamlCache Sessions = SamlRuntime.Cache;
        ...
        public override void AssociateUserIdWithCurrentSession(string userId)
        {
            ...
            if (sessionIds == null)
            {
                ...
                Sessions.Insert(userIdLowerCase, sessionIds, null, SamlCache.NoAbsoluteExpiration, new TimeSpan(0, 0, SessionTimeout, 0));
            }
        ...
        private ISession CreateSession()
        {
            ...
            Sessions.Insert(sessionId.ToString(), session, null, SamlCache.NoAbsoluteExpiration, new TimeSpan(0, 0, SessionTimeout, 0));
            return session;
        }
    }
}
