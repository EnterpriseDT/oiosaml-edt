...
namespace dk.nita.saml20
{
    ...
    public class Saml20AttributeQuery
    {
        ...
        public void PerformQuery(SamlHttpContext context)
        {
        ...
        public void PerformQuery(SamlHttpContext context, IDPEndPoint endPoint)
        {
        ...
        public void PerformQuery(SamlHttpContext context, IDPEndPoint endPoint, string nameIdFormat)
        {
